...
public class SIGFrame extends javax.swing.JFrame {
 ...
 private ArrayList<InvData> invoices;
    ...
    private InvTable invoicesTable;
    ...
    public void setInvoices(ArrayList<InvData> invoices) {
     ...
     public InvTable getInvoicesTable() {
        if (invoicesTable == null) {
            invoicesTable = new InvTable(getInvoices());
        }
        return invoicesTable;
    }

    public void setInvoicesTable(InvTable invoicesTable) {
